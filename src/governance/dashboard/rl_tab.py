"""
rl_tab.py — Tab 4: RL Training Results.

Loads CSV files from results/rl/ generated by scripts/train_governed_agent.py,
scripts/train_minigrid.py, and scripts/train_safety_grid.py.
